...
export const DM_CASE_STUDIES = [
  {
    ...
    services: ['Instagram Growth', 'Local SEO', 'Content System', 'Google Business'],
    ...
    outcome: 'Established a professional digital presence across Instagram and Google — ready for organic growth.',
  ...
  },
  {
    ...
    services: ['Web Architecture', 'Brand Refresh', 'Content Templates', 'Performance UI'],
    ...
    outcome: 'A cohesive, modern digital presence that accurately represents the quality of the firm\'s services.',
    result: 'A cohesive, modern digital presence that accurately represents the quality of the firm\'s services.',
  },
  {
    isSample: true,
    client: 'Specialty Healthcare Clinic',
    industry: 'Healthcare & Wellness',
    services: ['Landing Page', 'Local 3-Pack SEO', 'Educational Video', 'WhatsApp Routing'],
    challenge: 'High patient drop-off on legacy mobile pages and minimal organic discoverability for core procedures.',
    strategy: 'Fast appointment landing page, structured procedure FAQ schema markup, and patient-first educational short video series.',
    execution: 'Sub-second mobile site, Google Maps listing verification, 12 doctor-led educational video shorts, and automated WhatsApp appointment routing.',
    outcome: 'Streamlined patient consultation enquiries with an intuitive, trustworthy digital booking experience.',
    result: 'Streamlined patient consultation enquiries with an intuitive, trustworthy digital booking experience.',
  },
];
