              ...
              <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-3 mb-8">
                <div className="relative flex-1">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-3.5 rounded-xl border border-navy/10 dark:border-white/15 bg-mist dark:bg-white/5 text-navy dark:text-white placeholder:text-slatesoft dark:placeholder:text-white/55 focus:border-royal/50 transition-colors"
                  />
                </div>
                <button
                  type="submit"
