...
export default function WhatsAppButton() {
  ...
  const getCustomMessage = () => {
    ...
    if (path.includes('digital-marketing')) {
      return "Hi ATS Group of Companies, I'm interested in your digital marketing services. I'd like to know more about your solutions.";
    }
    if (path.includes('it-solutions')) {
      return "Hi ATS, I'm looking for IT solutions for my business.";
    }
    return "Hi ATS, I'm interested in your courses and internship programs.";
  };

  const message = getCustomMessage();
  const href = `https://wa.me/${CONTACT.phoneRaw}?text=${encodeURIComponent(message)}`;
  ...
  return (
    <a
      ...
      aria-label="Chat with ATS Group on WhatsApp"
