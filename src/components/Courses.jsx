        ...
        <div className="flex flex-wrap items-end justify-between gap-8">
          ...
          <div className="relative w-full sm:w-72">
            ...
            <input
              ...
              className="w-full pl-11 pr-4 py-3 rounded-xl border border-navy/10 dark:border-white/15 bg-mist dark:bg-white/5 text-navy dark:text-white placeholder:text-slatesoft dark:placeholder:text-white/55 text-sm focus:border-royal/50 transition-colors"
            />
          </div>
        </div>
